...
from src.netechos.core import NetworkModel
...
class TestGenerator:
    ...
    def test_create_network(self: Self) -> Self:
        ...
        nimodel = NetworkModel(number_of_nodes=10, interaction_type="symmetric")
        nimodel.create_network(network_type="erdos_renyi", p=0.1)
        assert hasattr(nimodel, "social_network"), "Social network is missing."
    ...
    def test_initialize_connections(self: Self) -> Self:
        ...
        assert hasattr(nimodel, "connections"), "Adjacency matrix is missing."
    ...
    def test_initialize_attitudes(self: Self) -> Self:
        ...
        assert hasattr(nimodel, "attitudes"), "Attitude vector is missing."
...
class TestDynamics:
    ...
    def test_make_symmetric_interactions(self: Self) -> Self:
        ...
        assert hasattr(nimodel, "interactions"), "Interaction matrix is missing."
        ...
        assert np.all(nimodel.interactions == nimodel.interactions.transpose()), (
    ...
    def test_make_asymmetric_interactions(self: Self) -> Self:
        ...
        nimodel = NetworkModel(number_of_nodes=10, interaction_type="asymmetric")
        nimodel.create_network(network_type="erdos_renyi", p=0.1)
        nimodel.initialize_connections()
...
class TestSimulator:
    ...
    def test_initialize_summary_table(self: Self) -> Self:
        ...
        assert hasattr(nimodel, "summary_table"), "Simulation summary table is missing."
    ...
    def test_update_summary_table(self: Self) -> Self:
        ...
        for col in required_columns:
            assert (
                nimodel.summary_table[col].is_finite().all()
    ...
    def test_initialize_attitude_tracker(self: Self) -> Self:
        ...
        required_columns = ["time", "node", "attitude"]
    ...
    def test_update_attitude_tracker(self: Self) -> Self:
        ...
        for col in required_columns:
            assert (
                nimodel.attitude_tracker[col].is_finite().all()
